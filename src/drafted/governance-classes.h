 ...
 *
 *   // network
 *   CAdnNetwork lvl, network-type, network-status, network-error, milestone-status*
...
private:
    ...
    // Current OBJECT STATUS (see http://govman.adn.org/index.php/Documentation_:_Status_Field)
    int nStatusID;
...
// // root node
class CAdnNetwork : public CGovernanceObject
{
private:
    std::string strName;
    std::string strURL;
...
// // can be under: AdnNetwork
// //   -- signature requirements : Key1(User)
// class CAdnNetworkVariable : public CGovernanceObject
// {
// private:
