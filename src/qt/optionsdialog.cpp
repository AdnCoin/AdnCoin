    ...
    mapper(0)
{
    ...
    /* Theme selector */
    ui->theme->addItem(QString("ADN-light"), QVariant("light"));
    ui->theme->addItem(QString("ADN-blue"), QVariant("drkblue"));
    ui->theme->addItem(QString("ADN-Crownium"), QVariant("crownium"));
    ui->theme->addItem(QString("ADN-traditional"), QVariant("trad"));
