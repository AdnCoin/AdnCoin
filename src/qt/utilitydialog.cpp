...
All the Adn in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.1 ADN, 1 ADN, 10 ADN, and 100 ADN--sort of like the paper money you use every day.</li> \
...
For more info see <a href=\"https://adnpay.atlassian.net/wiki/display/DOC/PrivateSend\">https://adnpay.atlassian.net/wiki/display/DOC/PrivateSend</a> \
        "));
        ui->aboutMessage->setWordWrap(true);
        ui->helpMessage->setVisible(false);
        ui->aboutLogo->setVisible(false);
