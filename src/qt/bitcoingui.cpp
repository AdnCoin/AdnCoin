...
void BitcoinGUI::createActions()
{
    ...
    aboutAction = new QAction(QIcon(":/icons/" + theme + "/about"), tr("&About Adn Core"), this);
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Adn Core"));
    ...
    showHelpMessageAction->setStatusTip(tr("Show the Adn Core help message to get a list with possible Adn Core command-line options"));
