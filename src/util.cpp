...
const char * const BITCOIN_CONF_FILENAME = "adn.conf";
const char * const BITCOIN_PID_FILENAME = "adnd.pid";
...
boost::filesystem::path GetDefaultDataDir()
{
    ...
    // Windows < Vista: C:\Documents and Settings\Username\Application Data\AdnCore
    // Windows >= Vista: C:\Users\Username\AppData\Roaming\AdnCore
    // Mac: ~/Library/Application Support/AdnCore
    // Unix: ~/.adncore
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "AdnCore";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/AdnCore";
#else
    // Unix
    return pathRet / ".adncore";
#endif
#endif
}
                    ...
                    map<string, vector<string> >& mapMultiSettingsRet)
{
    ...
    if (!streamConfig.good()){
        // Create empty adn.conf if it does not excist
